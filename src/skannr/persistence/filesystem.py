...
Events are appended under runtime/logs/<collector>/<date>.jsonl. Derived
summaries live under runtime/logs/device_history/ and are intentionally
separate from the raw audit logs.
"""
...
class FilesystemPersistence(BasePersistence):
    ...
    def write(self, event):
        """Append one event to runtime/logs/<collector>/<YYYY-MM-DD>.jsonl."""
