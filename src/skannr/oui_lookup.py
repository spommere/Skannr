...
Skannr never reaches out to the Internet during scans. Shipped IEEE registry
files live under src/skannr/data/collectors; callers still get useful fallback
